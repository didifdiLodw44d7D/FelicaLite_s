================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : FelicaLiteS001 プロジェクトの概要
===============================================================================

この FelicaLiteS001 アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、FelicaLiteS001 アプリケーションを構成する各ファイルの内容の概要が含まれています。

FelicaLiteS001.vcxproj
...
FelicaLiteS001.vcxproj.filters
...
FelicaLiteS001.h
    ...
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CFelicaLiteS001App アプリケーション クラスを宣言します。

FelicaLiteS001.cpp
    これはメインのアプリケーション ソース ファイルで、CFelicaLiteS001App アプリケーション クラスが含まれています。
...
res\FelicaLiteS001.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル FelicaLiteS001.rc にインクルードされます。

res\FelicaLiteS001.rc2
...
FelicaLiteS001Dlg.h, FelicaLiteS001Dlg.cpp - ダイアログ
    これらのファイルには、CFelicaLiteS001Dlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる FelicaLiteS001.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、FelicaLiteS001.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

FelicaLiteS001.manifest
